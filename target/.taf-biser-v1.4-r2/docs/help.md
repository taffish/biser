...
Notes:
  ...
  - This release currently declares linux/amd64 only. Native arm64 support is
    not claimed for BISER 1.4-r2.
  - Docker and Podman runs embed --platform linux/amd64 in src/main.taf, so
    arm64 hosts can use amd64 emulation without setting a global platform
    variable. This is emulation, not native arm64 support.
